...
// [DEPRECATED: classic frontend - slated for removal] Only "default" is accepted;
// "classic" is silently remapped to "default". Other values are silently ignored.
