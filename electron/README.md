# Ocean API Electron Desktop App

This directory contains the Electron wrapper for Ocean API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Ocean API/data/`
  - Windows: `%APPDATA%/Ocean API/data/`
  - Linux: `~/.config/Ocean API/data/`
